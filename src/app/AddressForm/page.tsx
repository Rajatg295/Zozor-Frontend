...
//       <button
//         type="button"
//         onClick={handleCancel}  // Add a handler function for cancel action
//         className="bg-gray-500 text-white w-32 py-1 px-4 rounded hover:bg-gray-600"
//       >
//         Cancel
//       </button>
//       <button
...
const AddressForm: React.FC<AddressFormProps> = ({
  ...
  return (
    <form onSubmit={handleAddressFormSubmit} className="mt-4 p-4 rounded">
      <div className="flex flex-col gap-4">
        <div className="grid grid-cols-2 gap-4">
          <input
            type="text"
        ...
        <div className="flex justify-end gap-4 mt-2">
          <button
            ...
            className="bg-red-200 text-red-500 w-32 py-1 px-4 rounded"
          >
            Cancel
          </button>
          <button
