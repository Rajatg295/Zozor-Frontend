      ...
      <div className="lg:w-[90%] md:w-[90%] w-full flex lg:flex-row md:flex-row flex-col gap-4 relative">
        ...
        <div className="h-max lg:w-80 md:w-80 w-full bg-whitelg:gap-4 md:gap-4 gap-2 rounded-[5px] z-40">
            <div className="flex flex-col p-4">
              ...
              <button onClick={() => handleBuyNow(product)} className="py-3 px-5 rounded-[10px] bg-red-500 font-semibold text-white border-[1px] border-primary hover:text-primary transition ease-in duration-2000 mt-2 lg:w-72 md:w-72 w-full">
                BUY NOW
              </button>
